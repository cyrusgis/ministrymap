...
var d4lFT = L.geoJSON(d4l, {
    pointToLayer: function (feature, latlng) {
      ...
      return L.marker(latlng, { icon: d4lIcon });
    },
    onEachFeature: function (feature, layer) {
      // Bind a popup to each marker
      layer.bindPopup(feature.properties.Status);
...
var encoreFT = L.geoJSON(encore, {
  pointToLayer: function (feature, latlng) {
    // Create a marker with custom icon
    return L.marker(latlng, { icon: encoreIcon });
  },
    onEachFeature: function (feature, layer) {
      // Bind a popup to each marker
      layer.bindPopup(feature.properties.Status);
...
var ismFT = L.geoJSON(ism, {
  pointToLayer: function (feature, latlng) {
    // Create a marker with custom icon
    return L.marker(latlng, { icon: ismIcon });
  },
    onEachFeature: function (feature, layer) {
      // Bind a popup to each marker
      layer.bindPopup(feature.properties.Status);
...
var nationsFT = L.geoJSON(nations, {
  pointToLayer: function (feature, latlng) {
    // Create a marker with custom icon
    return L.marker(latlng, { icon: nationsIcon });
  },
    onEachFeature: function (feature, layer) {
      // Bind a popup to each marker
      layer.bindPopup(feature.properties.Status);
